...
import styles from './QuantumultXScriptAddDeviceID.css';
import URLSafeBase64 from 'urlsafe-base64';
import copy from 'copy-to-clipboard';

class QuantumultXScriptAddDeviceIDGenerateForm extends React.Component {
  state = {
    showResult: false,
    result: ''
  };
...
const WrappedQuantumultXScriptAddDeviceIDGenerateForm = Form.create({ name: 'generate' })(QuantumultXScriptAddDeviceIDGenerateForm);
  ...
  return (
    <div>
      <Breadcrumb style={{ margin: '16px 0' }}>
        ...
        <Breadcrumb.Item>QuantumultXScriptAddDeviceID</Breadcrumb.Item>
      </Breadcrumb>
      ...
      <WrappedQuantumultXScriptAddDeviceIDGenerateForm />
    </div>
  );
}
